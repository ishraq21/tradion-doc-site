...
<AccordionGroup>
  ...
  <Accordion title="Chart Analyzer">
    Drop in a saved chart image and get a directional verdict — BUY, SELL, WAIT, or NO TRADE — with a 0–100 confidence score, an entry price, a stop, a target, and the factors behind the call. Available on every paid plan with no monthly cap. See [Chart Analyzer](/research/chart-analyzer).
  </Accordion>
