  ...
  <Accordion title="I can't sign in" icon="key">
    <Steps>
      ...
      <Step title="If it says your account is deactivated or scheduled for deletion">
        Both are deliberate states, not bugs. Email support@tradionlabs.com from the address on the account.
      </Step>
  ...
  <Accordion title="The magic link didn't arrive" icon="envelope">
    <Steps>
      ...
      <Step title="Corporate mail filters">
        On a work address, a filter is the likely cause. Use a personal address, or ask us at support@tradionlabs.com.
      </Step>
    </Steps>
  </Accordion>
