...
<Frame caption="The app: a sidebar grouped by what you're trying to do, and the screen you picked filling the rest.">
  <img src="/images/diagrams/app-anatomy.svg" alt="The Tradion interface, with a sidebar grouped into Overview, Research and Analysis, Trade Intelligence, and Automate, alongside the Portfolio screen" />
</Frame>
