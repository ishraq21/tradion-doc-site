...
<Steps>
  <Step title="Research the market" icon="magnifying-glass-chart">
    Ask a question in plain English and get back live-data analysis with interactive charts in [AI Quant Research](/research/quant-research). For a chart rather than a question: drop a saved image into [Chart Analyzer](/research/chart-analyzer), or drive a live chart inside Tradion with [Lens](/research/lens).
  </Step>
