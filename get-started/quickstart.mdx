---
title: "Quickstart"
description: "Six steps from signup to your first analysis in about ten minutes: create an account, pick a plan, connect a brokerage, run an analysis, and log a trade."
icon: "rocket"
---
