---
title: "Quickstart"
description: "Signup to your first answer in about ten minutes."
icon: "rocket"
---
...
<Note>
  **Use a desktop or laptop.** The charts and workspaces need the screen space, so Tradion blocks phone-sized windows. A tablet works.
</Note>
...
Starter ($25) is every analysis tool: Chart Analysis, Lens, Trade Autopsy, and the AI Portfolio Analyst with a monthly message allowance. Trader ($100) adds AI Earnings Research. Quant ($200) is Trader with much bigger monthly allowances.

Starter and Trader include a 7-day trial; Quant doesn't. → [Choosing a plan](/get-started/choosing-a-plan)

## 4. Connect a brokerage

Optional, but about half of what makes Tradion useful depends on knowing what you hold: the portfolio dashboard, the AI Portfolio Analyst, and automatic trade import.
...
<AccordionGroup>
  <Accordion title="I have a question about my portfolio" icon="comments">
    Open the **AI Portfolio Analyst** and type it the way you'd say it out loud, *"which of my positions carries the most risk right now?"* It reads your real holdings, pulls live prices where it needs them, and answers with charts and a written explanation.

    Needs a connected brokerage or manual positions to be specific to you. → [AI Portfolio Analyst](/portfolio/ai-portfolio-analyst)
  </Accordion>
  <Accordion title="I have a chart image saved" icon="image">
    Open **Chart Analysis** and drop it in. You get a BUY / SELL / HOLD / NO TRADE call with an entry price, a stop, a target, and a breakdown of which factors drove the score.

    → [Chart Analysis](/research/chart-analyzer)
  </Accordion>
  ...
  <Accordion title="I want to understand a company's quarter" icon="file-lines">
    Open **AI Earnings Research** (Trader and Quant). Name a company and ask, for example "Did AMD beat expectations last quarter?" Tradion reads the filings, the earnings call and the analyst estimates, and answers with every figure tied to its source.
...
<CardGroup cols={2}>
  <Card title="The Tradion Loop" icon="arrows-rotate" href="/concepts/the-loop">
    The mental model that makes the rest of the docs easier to read.
  </Card>
  <Card title="AI Portfolio Analyst" icon="comments" href="/portfolio/ai-portfolio-analyst">
    Ask about your own positions, run what-ifs, and get charts back.
  </Card>
