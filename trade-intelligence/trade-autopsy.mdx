...
<Frame caption="The Overview tab: your three scores, the trades you have logged, the patterns that keep repeating, and your pre-flight card.">
  <img src="/images/screens/trade-autopsy-overview.jpg" alt="The Trade Autopsy overview showing entry quality, exit discipline and risk management scores, a recent autopsies table, a mistake patterns panel, and a pre-flight checklist" noZoom />
</Frame>
...
| Tab | What's in it |
| --- | --- |
| **Overview** | Your three running scores, a process-versus-outcome scatter, setup performance, recent autopsies, your winning and losing patterns, and a Pre-Flight Checklist card |
...
On Overview, each score carries a [sparkline](/help/glossary) that you read for shape rather than value, and the scatter plots one dot per trade against both grades at once. The two pattern panels are named **Your Edge** and **Mistake Patterns**.
