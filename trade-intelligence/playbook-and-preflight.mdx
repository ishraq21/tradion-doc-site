...
<Frame caption="The loop this page closes: a finding becomes a rule, and the rule is read before the next entry.">
  <img src="/images/diagrams/autopsy-loop.svg" alt="Circular diagram showing a trade leading to an autopsy, the autopsy producing a pattern, the pattern producing a playbook rule, and the rule feeding a pre-flight check before the next trade" />
</Frame>
