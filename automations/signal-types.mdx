...
A signal is a question Tradion asks once a minute: *is RSI under 30 right now?* Every signal has to answer yes at the same moment for a message to go out. Mixing categories beats stacking two indicators that move together.
