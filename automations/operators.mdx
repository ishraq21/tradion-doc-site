...
<Frame caption="Same price path, same level, two operators. One alert against dozens.">
  <img src="/images/diagrams/crosses-vs-is.svg" alt="A price line crossing a threshold, showing one firing point for a crossing operator and many firing points for a continuous operator" noZoom />
</Frame>
...
If you use a continuous operator anywhere, set a **cooldown** to match. That is the minimum quiet period after a trigger, set on the Action node. The default is one hour.
