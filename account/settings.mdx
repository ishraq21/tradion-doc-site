...
<Frame caption="Settings. Profile details, connected brokerages, and your subscription, in one place.">
  <img src="/images/screens/account-settings.jpg" alt="The Account Settings screen showing profile name and email fields, a connected brokerage with sync and disconnect buttons, and a subscription and billing section" noZoom />
</Frame>
...
Four meters, each showing *remaining / total* with a bar, plus the date they reset:

- **AI Portfolio Analyst Messages**, your portfolio chat.
- **AI Earnings Research Messages**, questions you send in AI Earnings Research. Trader and Quant only.
- **Agent Runs**, executions of an AI agent step inside an automation. Trader and Quant only.
- **Quant Sessions**, analyses started in AI Quant Research, where Python runs in a sandbox. Trader and Quant only.
