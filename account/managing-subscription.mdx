...
description: "How to upgrade, downgrade, update your payment method, and cancel in Settings, plus subscription statuses and what happens when a payment fails."
icon: "receipt"
---
...
- Your remaining balances are **capped**, never topped up. If you had 200 AI Asset Manager messages left and drop to a tier with a 150 ceiling, you keep 150. If you had 40 left, you keep 40.
