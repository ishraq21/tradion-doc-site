...
<Frame caption="The panels sit in a fixed order — value and chart first, exposure second, holdings third, accounts last.">
  <img src="/images/diagrams/portfolio-anatomy.svg" alt="Labelled diagram of the Portfolio dashboard showing the net worth panel, range selector, allocation and diversification panel, holdings table, top movers, and account breakdown" />
</Frame>
