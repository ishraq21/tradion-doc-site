...
<Frame caption="Chat on the right, thread history in the left rail, charts rendered inline in the answer.">
  <img src="/images/diagrams/asset-manager-anatomy.svg" alt="Labelled diagram of the AI Asset Manager workspace showing the session history rail, message thread, an embedded chart, and the composer" />
</Frame>
