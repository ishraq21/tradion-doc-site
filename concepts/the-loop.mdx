...
```mermaid
flowchart LR
    A["Research<br/>Quant · Chart Analyzer<br/>Lens · AI Earnings Research"] --> B["Position<br/>Portfolio<br/>AI Portfolio Analyst"]
...
| Research & Analysis | AI Quant Research, AI Earnings Research, Chart Analyzer, Lens | Research |
| Trade Intelligence | Trade Autopsy, Profile, AI Portfolio Analyst | Autopsy + Position |
