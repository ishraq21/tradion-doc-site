...
An AI Asset Manager message is one message *you* send in the portfolio chat. The assistant's reply, and any internal tool calls it makes to read your holdings or pull quotes, are all free — the whole exchange counts as one message.
