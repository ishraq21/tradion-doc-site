...
<Frame caption="Settings → Monthly Usage shows live balances and the reset date.">
  <img src="/images/diagrams/usage-meters.svg" alt="Three meter rows — chat messages, quant sessions, and agent runs — each with a progress bar showing how much of the monthly allowance is used" />
</Frame>
