...
<Note>
  Starter has no quant sessions or agent runs because it doesn't include AI Quant Research or automations at all. It's the analysis-tools tier: Chart Analyzer, Lens, Earnings Spider, and Trade Autopsy, all unlimited.
</Note>
