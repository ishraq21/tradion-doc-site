...
Company financials, the earnings calendar, historical earnings results, company overview data, and screener output come from Alpha Vantage. This is what Earnings Spider compares a fresh report against, and what the AI Portfolio Analyst reads when you ask about a company's numbers rather than its chart.
