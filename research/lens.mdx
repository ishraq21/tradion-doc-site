...
<Warning>
  **Lens reads Tradion's own chart, not your other tabs.** It cannot capture a TradingView tab, a desktop platform, or anything else on your screen. If the chart you want is elsewhe<Frame caption="Signals and anomalies, each one a sentence rather than a number, and a box to ask follow-up questions.">
  <img src="/images/screens/lens-signals.jpg" alt="The Lens analysis panel scrolled to signals and anomalies, listing volume against its average, moving average positions, Fibonacci and Bollinger context, and relative strength against the index, above an ask-a-question box" />
</Frame>

re, screenshot it and use [Chart Analyzer](/research/chart-analyzer).
</Warning>

<Frame caption="The deciding question: is the chart inside Tradion, or already a file?">
  <img src="/images/diagrams/lens-vs-analyzer.svg" alt="Side-by-side comparison of the inputs and outputs of Lens and Chart Analyzer" noZoom />
</Frame>

<Frame caption="Lens after a capture. The chart you drove on the left, the read on the right, with a forecast and bull, base, and bear targets.">
  <img src="/images/screens/lens-analysis.jpg" alt="The Lens screen showing a daily candlestick chart with MACD and RSI panes, and an analysis panel giving a bullish call with probability, a written summary, a price forecast with bull, base and bear targets, and a trade setup with entry, stop and target" />
</Frame>
...
<Frame caption="Before you capture: a live chart you drive inside Tradion. Set the symbol, timeframe, and indicators, then hit Capture.">
  <img src="/images/screens/lens-chart.jpg" alt="The Lens screen showing a full-width daily candlestick chart with volume, MACD, and RSI panes, a symbol box, timeframe buttons, an indicators menu, and a Capture button" />
</Frame>
