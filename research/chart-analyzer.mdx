...
<Frame caption="Analysis history, every chart you have run, with its entry level and risk/reward ratio.">
  <img src="/images/screens/chart-analyzer-history.jpg" alt="Chart Analyzer history listing past TSLA and NVDA analyses, each with a summary, entry price, and risk to reward ratio" noZoom />
</Frame>
