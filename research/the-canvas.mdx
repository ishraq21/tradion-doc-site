...
<Frame caption="A cell holds the code that ran, its output, and a written reading of what the numbers mean.">
  <img src="/images/screens/quant-ml-analysis.jpg" alt="A quant canvas showing generated Python that fetches price data, an AI insight paragraph, and a daily bars table, with the left panel explaining classification metrics and a confusion matrix in plain language" noZoom />
</Frame>
