...
<Frame caption="Every part of a cell, and what each one is telling you. The Code toggle is the one most people never find.">
  <img src="/images/diagrams/cell-anatomy.svg" alt="Labelled diagram of a single canvas cell showing its number, title, status, code toggle, chart output, and AI summary" noZoom />
</Frame>
