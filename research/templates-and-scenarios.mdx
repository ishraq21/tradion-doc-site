...
<Frame caption="The template library. Categories across the top, and every template says what it does before you run it.">
  <img src="/images/screens/quant-templates.jpg" alt="The Quant Agent start screen with category chips for featured, technical, backtest, options, risk, screener, fundamental, crypto, portfolio, forex, AI and ML, SMC and ICT, scanner, similarity and SEC EDGAR, above template cards" />
</Frame>
