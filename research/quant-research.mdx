...
<Frame caption="A finished analysis. The written answer on the left, the synthesised dashboard on the right, live quote and headlines underneath.">
  <img src="/images/screens/quant-dashboard.jpg" alt="The quant terminal showing an NVDA financial statement analysis: an executive summary and live market snapshot on the left, and on the right a signal card with conviction, thesis, margins and next steps, a live quote strip, and a trade plan" noZoom />
</Frame>
