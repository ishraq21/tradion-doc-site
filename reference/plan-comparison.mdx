...
| --- | :---: | :---: | :---: |
| Chart Analyzer | Yes | Yes | Yes |
| Lens | Yes | Yes | Yes |
| Earnings Spider | Yes | Yes | Yes |
| Trade Autopsy | Yes | Yes | Yes |
| Tradion Memory | Yes | Yes | Yes |
| Portfolio dashboard | Yes | Yes | Yes |
| AI Asset Manager | Yes | Yes | Yes |
| AI Quant Research | No | Yes | Yes |
| Automations & alerting | No | Yes | Yes |
| AI agent nodes | No | Yes | Yes |
