...
Starter is every analysis tool with no monthly cap. Trader adds the quant terminal, automations and alerting. Quant is Trader with roughly ten times the allowances and a stronger agent model.
