...
- **AI Portfolio Analyst messages** are messages you send in the AI Portfolio Analyst portfolio chat. A **quant session** is one message in Analysis mode in AI Quant Research; Ask mode is free. An **agent run** is one AI agent step firing inside an automation.
