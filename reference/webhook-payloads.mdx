...
<Frame caption="The signature is computed over the exact bytes Tradion sends. Verify before you parse.">
  <img src="/images/diagrams/webhook-flow.svg" alt="Diagram showing an automation trigger producing a signed HTTPS POST to a customer endpoint, which verifies the signature before acting" noZoom />
</Frame>
